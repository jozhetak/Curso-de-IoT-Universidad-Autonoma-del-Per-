...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect("ESP8266Client_caballero")) {
      Serial.println("connected");
      // Once connected, publish an announcement...
      client.publish("caballero_out", "hello world");
      // ... and resubscribe
      client.subscribe("caballero_in");
    } else {
...
void loop() {
  ...
  if (now - lastMsg > 2000) {
    ...
    Serial.println(msg);
    client.publish("caballero_out", msg);
  }
}
